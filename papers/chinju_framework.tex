...
\author{
  ...
  $^1$Ugentropy Research Group\\
  \texttt{contact@ugentropy.org}
}
...
\smallskip
\noindent $^\dagger$Estimates based on component profiling; full integration benchmarks pending.
Measured on single inference calls with 7B parameter model.
\end{table}
